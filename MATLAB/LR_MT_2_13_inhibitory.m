...
conn_EI = RS*normrnd(0, sqrt(1/N_I), N_E,N_I); % 连接矩阵(E←I)
conn_EI = abs(conn_EI);
% conn_EI = RS*rand([N_E,N_I])*(1/N_I); % 连接矩阵(E←I)
conn_IE = RS*normrnd(0, sqrt(1/N_E), N_I,N_E); % 连接矩阵(I←E)
conn_IE = abs(conn_IE);
% conn_IE = RS*rand([N_I,N_E])*(1/N_E); % 连接矩阵(I←E)
conn_II = RS*normrnd(0, sqrt(1/N_I),N_I,N_I); % 连接矩阵(I←I)
conn_II = abs(conn_II);
...
%% Figure
path = '/Users/libin/Pictures/Ihibitory_no/';
mkdir('/Users/libin/Pictures/Ihibitory_no/')
mkdir('/Users/libin/Pictures/Ihibitory_no/connectivity/')
mkdir('/Users/libin/Pictures/Ihibitory_no/svg_go/')
mkdir('/Users/libin/Pictures/Ihibitory_no/svg_nogo/')
mkdir('/Users/libin/Pictures/Ihibitory_no/output/')
mkdir('/Users/libin/Pictures/Ihibitory_no/activity_go')
mkdir('/Users/libin/Pictures/Ihibitory_no/activity_nogo')
xaxis = dt:dt:T;
